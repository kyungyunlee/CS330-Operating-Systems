...
### So what is operating systems?
  Operating systems manage computer hardware, like CPU, memory and I/O devices. Also, it provides interaction between user application and hardware. It can be seen in user mode and kernel mode. Most of the operating system functions are driven by interrupts, like timer interrupt or I/O interrupt. OS will interprete the needs of user applications and propagate them to the hardware.  
...
* How to create new processes?
  * fork() vs creating from scratch
    * creating from scratch 
      * need new PCB, initialize with 0/null values
